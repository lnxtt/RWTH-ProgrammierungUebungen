...
public class KingArthur {
  public static void main(String[] args) {
    ...
    catch (UnspecificQuestionException uqe)
    {
    	System.out.println("Das haette nicht pasiieren sollen.");
    }
    
    try
    {
    	System.out.println("Troll: " + troll.askAboutAirspeedVelocity("Europeanswallow"));
    }
    catch (UnspecificQuestionException uqe)
    {
